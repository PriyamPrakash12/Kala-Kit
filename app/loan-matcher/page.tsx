...
export default function LoanMatcher() {
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold text-white text-center mb-10">Smart Loan Matcher</h1>
      ...
      <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-8 backdrop-blur-sm">
        ...
        <div className="border-2 border-dashed border-teal-500/50 rounded-xl p-10 flex flex-col items-center justify-center text-center hover:bg-slate-800/50 transition-colors cursor-pointer group">
